      ...
      <div class="row tm-albums-container grid">
        <div class="col-sm-6 col-12 col-md-6 col-lg-3 col-xl-3 tm-album-col">
          <figure class="effect-sadie">
            <img src="insertion-260x390-01.jpg" alt="Image" class="img-fluid">
            <figcaption>
              <h2>First Album</h2>
        ...
        <div class="col-sm-6 col-12 col-md-6 col-lg-3 col-xl-3 tm-album-col">
          <figure class="effect-sadie">
            <img src="insertion-260x390-02.jpg" alt="Image" class="img-fluid">
            <figcaption>
              <h2>Album Two</h2>
        ...
        <div class="col-sm-6 col-12 col-md-6 col-lg-3 col-xl-3 tm-album-col">
          <figure class="effect-sadie">
            <img src="insertion-260x390-03.jpg" alt="Image" class="img-fluid">
            <figcaption>
              <h2>Third Album</h2>
        ...
        <div class="col-sm-6 col-12 col-md-6 col-lg-3 col-xl-3 tm-album-col">
          <figure class="effect-sadie">
            <img src="insertion-260x390-04.jpg" alt="Image" class="img-fluid">
            <figcaption>
              <h2>Album Four</h2>
      ...
      <div class="row mb-5">
        <div class="col-xl-12">
          <div class="media-boxes">
            <div class="media">
              <img src="insertion-140x140-01.jpg" alt="Image" class="mr-3">
            ...
            <div class="media">
              <img src="insertion-140x140-02.jpg" alt="Image" class="mr-3">
            ...
            <div class="media">
              <img src="insertion-140x140-03.jpg" alt="Image" class="mr-3">
              <div class="media-body tm-bg-gray">
                <div class="tm-description-box">
            ...
            <div class="media">
              <img src="insertion-140x140-04.jpg" alt="Image" class="mr-3">
              <div class="media-body tm-bg-pink-light">
                <div class="tm-description-box">
            ...
            <div class="media">
              <img src="insertion-140x140-05.jpg" alt="Image" class="mr-3">
              <div class="media-body tm-bg-gray">
                <div class="tm-description-box">
